...
{
    public static X509Certificate2 LoadCertificateWithExportablePrivateKey(string pfxPath, string? password = null)
    {
        var certificates = LoadExportableCollection(pfxPath, password);
